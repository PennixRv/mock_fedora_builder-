...
bootloader --append="root=/dev/mmcblk1p4 rw console=tty0 console=ttyS0,115200 earlycon rootwait selinux=0" --location=none --timeout=1
...
part / --fstype="ext4" --grow --size=12288 --label=rootfs
...
Build date: Thu Dec  7 01:42:50 AM UTC 2023
